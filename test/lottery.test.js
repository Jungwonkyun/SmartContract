...
contract('Lottery', function([deployer, user1, user15 ,user2]){
    let lottery;
    ...
    describe('Distribute', function () {
        describe('When the answer is checkable', function () {
            it('should give the user the pot when the answer matches', async () => {
                ...
                await lottery.betAndDistribute('0xef', {from:user2, value:betAmount}) // 1 -> 4  1번 블록에서 4번 블록을 betting 
                await lottery.betAndDistribute('0xef', {from:user2, value:betAmount}) // 2 -> 5
                await lottery.betAndDistribute('0xab', {from:user1, value:betAmount}) // 3 -> 6 얘만 정답 
                ...
                console.log()
                console.log("Pot before 7th block")
                ...
                console.log("User1's balance before 7th block")
                console.log(user1BalanceBefore)
                console.log() 
                console.log("User2's balance before 7th block")
                console.log('99966001480000000000')
                ...
                console.log("Pot After 7th block")
                console.log(potAfter.toString())
                console.log()
                ...
                console.log("User1's balance After 7th block")
                console.log(user1BalanceAfter)
                console.log()
                console.log("User2's balance After 7th block")
                console.log('99866001480000000000')
